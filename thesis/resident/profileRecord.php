<?php
    ...
    $sql3 = "SELECT COUNT(or_id) FROM transactionlist_tbl WHERE resident_id = '$resident_id'";
    $res3 = $con->query($sql3);
...
<body>
        ...
        <div class="container mt-3 pt-4 mb-3">
            <div class="row">
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-md-12 border border-danger">
                            <a href="profile_resident" class="text-decoration-none"><p id="deliveryguy" class="text-center fs-4 text-danger">Profile</p></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 border bg-danger">
                            <a href="profileRecord.php" class="text-decoration-none"><p id="deliveryguy" class="text-center fs-4 text-white">Records</p></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 shadow-lg p-3 mb-5 bg-body rounded">
                  <div class="row mb-4">
                    <div class="col-md-5">
                      <i class="bi bi-table"></i>&nbsp;Your Transactions List
                    </div>
                  </div>
                  <div class="col-md-12">
                    <table id="example" class="table table-striped" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php
                        if($cnt1 > 0){
                          $qry3 = "SELECT * FROM transactionlist_tbl WHERE resident_id = '$resident_id'";
                          $dq3 =  $con->query($qry3);
                          foreach($dq3 as $qdata3){
                            $or_date1 = $qdata3['or_date'];
                            $or_date1 = date_create($or_date1);
                            $or_date1 = date_format($or_date1, 'F d, Y (h:i:s a)');
                          ?>
                          <tr>
                          <th><?=$qdata3['tran_type'];?></th>
                          <?php
                            if($qdata3['status'] == 3){
                              echo '<th>Received</th>';
                            }
                            elseif($qdata3['status'] == 2){
                              echo '<th>Pending</th>';
                            }
                            else{
                              echo '<th>On-going</th>';
    ...
    <div class="modal fade" id="addregmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-xl">
            <div class="modal-content">
                ...
                ?>
                <form action="profileRecord.php" method="post"  enctype="multipart/form-data">
  ...
  <!-- footer -->
  <footer class="text-center text-white bg-danger fixed-bottom">
    <!-- Copyright -->

<?php
  ...
  if(isset($_SESSION['userresident']['resident_id'])){
    ...
    $userresid = $_SESSION['userresident']['resident_id'];
  ...
  if(isset($_REQUEST['addtrans'])){
    ...
    /** query to get the appropriate data from the database */ 
    $sql2 = "SELECT * FROM penresident WHERE resident_id = '$userresid'";
    $d2 =  $con->query($sql2);
    foreach($d2 as $data2){
  ...
  if(isset($_REQUEST['confirmadd'])){
    ...
    $purpose = ucfirst(strtolower(filter_var($_REQUEST['purpose'],FILTER_SANITIZE_STRING)));
    try{
      $query3 = $con->prepare("INSERT INTO transactionlist_tbl (or_id, resident_id, tran_id, tran_type, quantity, total_amount, or_date, purpose, status)
      VALUES (:or_id, :resident_id, :tran_id, :tran_type, :quantity, :total_amount, :or_date, :purpose, :status)");
      /** executing the query */
      if($query3->execute(
        [
        ':or_id' => $or_id,
        ':resident_id' => $userresid,
        ':tran_id' => $tran_id,
        ':tran_type' => $tran_name,
        ':quantity' => $quantity,
...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-danger fixed-top ps-2 pe-2">
    <a class="navbar-brand text-uppercase fs-4" href="https://barangayconcepciondos.com/">
    ...
    <div class="collapse navbar-collapse" id="navbuttons">
        <ul class="navbar-nav text-center">
            <li class="nav-item">
                <a href="https://barangayconcepciondos.com/" class="nav-link">
                    Home
                </a>
            </li>
            <li class="nav-item">
                <a href="https://barangayconcepciondos.com/#announcetarget" class="nav-link">
                    Announcements
                </a>
            </li>
            <li class="nav-item">
                <a href="https://barangayconcepciondos.com/#eventtarget" class="nav-link">
                    Events
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    if(isset($_SESSION['userresident']['resident_id'])){
                        $resident_id = $_SESSION['userresident']['resident_id'];
                        ?>
                        <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#choosetpye">Documents</a></li>
                        ...
                        ?>
                        <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#brgycert">Documents</a></li>
                        <hr class="dropdown-divider">
      ...
      <div class="offcanvas-body pt-3">
          <ul class="navbar-nav text-start pb-3">
              <li class="nav-item active">
                  <a href="https://barangayconcepciondos.com/" class="nav-link active text-white">
                      Home
                  </a>
              </li>
              <li class="nav-item">
                  <a href="https://barangayconcepciondos.com/#announcetarget" class="nav-link text-white" data-bs-dismiss="offcanvas">
                      Announcements
                  </a>
              </li>
              <li class="nav-item">
                  <a href="https://barangayconcepciondos.com/#eventtarget" class="nav-link text-white" data-bs-dismiss="offcanvas">
                      Events
                  </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                  <a href="aboutus.php" class="nav-link text-white active">
                      About Us
                  </a>
              </li>
              <li>
                  ...
                  <div class="collapse" id="reports">
                      <div class="card card-body bg-white">
                          ...
                          if(isset($_SESSION['userresident']['resident_id'])){
                              $resident_id = $_SESSION['userresident']['resident_id'];
                              ?>
                              <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#choosetpye" data-bs-dismiss="offcanvas">Documents</a></li>
                              <hr class="dropdown-divider">
                              ...
                              ?>
                              <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#brgycert" data-bs-dismiss="offcanvas">Documents</a></li>
                              <hr class="dropdown-divider">
  ...
  <main class="mt-4 pt-4 ms-4 me-4 mb-4">
    <section class="mt-4">
        <div class="container d-flex justify-content-center">
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-dark" href="#serv" role="button">Services</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-dark" href="#contbutton" role="button">Contact Us</a>
                </div>
            </div>
        </div>
    </section>
    <section class="mt-3 shadow-lg p-4 bg-body rounded">
        <div class="row d-flex justify-content-center">
            <div class="col-md-7">
                ...
                <p class="fs-5 text-center"><?=$aboutus?></p>
            </div>
        </div>
    </section>
    <section class="mt-3 shadow-lg p-0 bg-body rounded">
        <div class="row">
            <div class="col-md-7 p-5">
                ...
                <p class="fs-5 text-center "><?=$mission?></p>
            </div>
    ...
    <section class="mt-3 shadow-lg p-0 bg-body rounded">
        <div class="row">
            ...
            <div class="col-md-7 p-5">
                ...
                <p class="fs-5 text-center"><?=$vision?></p>
            </div>
        </div>
    </section>
    <section class="mt-3  shadow-lg p-4 bg-body rounded">
        <div class="row d-flex justify-content-center">
            <div class="col-md-12">
                ...
                <p class="fs-5 text-center"><?=$demographics?></p>
            </div>
        </div>
    </section>
    <section class="mt-3  shadow-lg p-4 bg-body rounded">
        <div class="row d-flex justify-content-center">
            <div class="col-md-12">
                ...
                <p class="fs-5 text-center"><?=$location?></p>
            </div>
        </div>
    </section>
    <section id="contbutton" class="mt-3 shadow-lg bg-body rounded">
        <div class="bgs shadow-lg p-1 bg-body rounded">
            <div class="row d-flex justify-content-center">
                <div class="col-md-7">
                    <p class="text-center fs-1"><h1 style="text-shadow: 2px 2px 5px white;" class="text-center">Contact Us</h1></p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 text-center">
                    <div class="bg-light m-2 rounded p-1 shadow-lg bg-body rounded">
                        ...
                        <p class="fs-5 text-center">Telephone: (02) <?=$telephone?></p> 
                        <p class="fs-5 text-center">Smart/TnT: <?=$smart?></p> 
                        <p class="fs-5 text-center">Globe/TM: <?=$globe?></p> 
                    </div>              
                </div>
                <div class="col-md-6 text-center">
                    <div class="bg-light m-2 p-1 shadow-lg bg-body rounded">
                        ...
                        <p style="word-break: normal;" class="text-center"><a class="btn btn-link text-dark" href="mailto: concepciondosmarikina@gmail.com" role="button"><i class="bi bi-envelope me-2"></i>concepciondosmarikina@gmail.com</a></p>
                    </div>              
                </div>
            </div>
        </div>
            ...
            <?php
                    ...
                    ?>
                                ...
                                if(isset($_SESSION['userresident']['resident_id'])){
                                    ...
                                    ?>
                                    <p class="text-center fs-5"><button type="button" class="btn btn-light" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#brgycert">Avail now!</button></p>
                                    <?php
                                }
                                ?>
                        </div>
    ...
    <!-- adding confirmation pop-up modal -->
    <div class="modal fade" id="tranaddconfmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header p-3 mb-2 bg-secondary text-white">

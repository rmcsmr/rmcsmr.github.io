  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-danger fixed-top ps-2 pe-2">
    ...
    <div class="collapse navbar-collapse" id="navbuttons">
        <ul class="navbar-nav text-center">
            ...
            <li class="nav-item">
                <a href="officials.php" class="nav-link active">
                    Officials
                </a>
            </li>
            <li class="nav-item">
  ...
  <div class="offcanvas offcanvas-start bg-danger ps-2 pe-2" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      ...
      <div class="offcanvas-body pt-3">
          <ul class="navbar-nav text-start pb-3">
              ...
              <li class="nav-item">
                  <a href="officials.php" class="nav-link text-white active">
                      Officials
                  </a>
              </li>
              <li class="nav-item">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
              <?php
              $qry1 = "SELECT * FROM officials_tbl WHERE official_id = '1'";
              $dq1 =  $con->query($qry1);
              
              foreach($dq1 as $qdata1){
                  $resident_id = $qdata1['resident_id'];
                  $official_img = $qdata1['official_img'];
              }
              if($resident_id == ''){
                  echo '<img src="images/adult.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                  <h4>No assigned official yet</h4>';
              }
              else{
                  $qrys1 = "SELECT * FROM penresident WHERE resident_id = '$resident_id'";
                  $dqs1 =  $con->query($qrys1);
                  
                  foreach($dqs1 as $qdatas1){
                      if($qdatas1['profile_id'] == ''){
                          if($qdatas1['gender'] == 'Male'){
                              echo '<img src="images/adult.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                              <h4>Hon. '.$qdatas1['firstname'].' '.$qdatas1['middlename'].' '.$qdatas1['lastname'].'</h4>';
                          }
                          else{
                              echo '<img src="images/adult_f.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                              <h4>Hon. '.$qdatas1['firstname'].' '.$qdatas1['middlename'].' '.$qdatas1['lastname'].'</h4>';
                          }
                          
                      }
                      else{
                          echo '<img src="../resident/images/'.$qdatas1['profile_id'].'" class="rounded-circle" width="150;" height="150;"alt="...">
                          <h4>'.$qdatas1['lastname'].', '.$qdatas1['firstname'].' '.$qdatas1['middlename'].'.</h4>';
                      }
                  }
              }
              ?>
        ...
        <div class="row">
            <?php
            $qry2 = "SELECT * FROM officials_tbl WHERE official_id < '5' AND official_id > '1'";
            $dq2 =  $con->query($qry2);
            
            foreach($dq2 as $qdata2){
                $resident_id = $qdata2['resident_id'];
                $official_img = $qdata2['official_img'];
              if($resident_id == ''){
                  echo '<div class="col-md-4 text-center">
                  <img src="images/adult.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                  <h4>No assigned official yet</h4>';
              }
              else{
                  $qrys2 = "SELECT * FROM penresident WHERE resident_id = '$resident_id'";
                  $dqs2 =  $con->query($qrys2);
                  
                  foreach($dqs2 as $qdatas2){
                      if($qdatas2['profile_id'] == ''){
                          if($qdatas2['gender'] == 'Male'){
                              echo '<div class="col-md-4 text-center">
                              <img src="images/adult.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                              <h4>Hon. '.$qdatas2['firstname'].' '.$qdatas2['middlename'].' '.$qdatas2['lastname'].'</h4>';
                          }
                          else{
                              echo '<div class="col-md-4 text-center">
                              <img src="images/adult_f.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                              <h4>Hon. '.$qdatas2['firstname'].' '.$qdatas2['middlename'].' '.$qdatas2['lastname'].'</h4>';
                          }
                          ...
                          echo '<div class="col-md-4 text-center">
                          <img src="../resident/images/'.$qdatas2['profile_id'].'" class="rounded-circle" width="150;" height="150;"alt="...">
                          <h4>'.$qdatas2['lastname'].', '.$qdatas2['firstname'].' '.$qdatas2['middlename'].'.</h4>';
                      }
                  }
              }
            ?>
        ...
        <div class="row mt-3">
          <?php
            $qry3 = "SELECT * FROM officials_tbl WHERE official_id < '9' AND official_id > '4'";
            $dq3 =  $con->query($qry3);
            
            foreach($dq3 as $qdata3){
                $resident_id = $qdata3['resident_id'];
                $official_img = $qdata3['official_img'];
              if($resident_id == ''){
                  ...
                  $qrys3 = "SELECT * FROM penresident WHERE resident_id = '$resident_id'";
                  $dqs3 =  $con->query($qrys3);
                  
                  foreach($dqs3 as $qdatas3){
                      if($qdatas3['profile_id'] == ''){
                          if($qdatas3['gender'] == 'Male'){
                              echo '<div class="col-md-3 text-center">
                              <img src="images/adult.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                              <h4>Hon. '.$qdatas3['firstname'].' '.$qdatas3['middlename'].' '.$qdatas3['lastname'].'</h4>';
                          }
                          else{
                              echo '<div class="col-md-3 text-center">
                              <img src="images/adult_f.jpg" class="rounded-circle" width="150;" height="150;"alt="...">
                          ...
                          echo '<div class="col-md-3 text-center">
                          <img src="../resident/images/'.$qdatas3['profile_id'].'" class="rounded-circle" width="150;" height="150;"alt="...">
                          <h4>'.$qdatas3['lastname'].', '.$qdatas3['firstname'].' '.$qdatas3['middlename'].'.</h4>';
                      }
                  }
              }
            ?>
        ...
        <div class="row">
          <?php
            $qry2 = "SELECT * FROM officials_tbl WHERE official_id < '11' AND official_id > '8'";
            $dq2 =  $con->query($qry2);
            
            foreach($dq2 as $qdata2){
                $resident_id = $qdata2['resident_id'];
                $official_id = $qdata2['official_id'];
                $official_img = $qdata2['official_img'];
              if($resident_id == ''){
              ...
              if($official_id == '9'){
                echo '<h5>Barangay Secretary</h5>';
              }
              else{
                echo '<h5>Barangay Treasurer</h5>';
              }
            ?>

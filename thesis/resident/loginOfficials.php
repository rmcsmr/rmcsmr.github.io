...
<body>
            ...
            <ul class="navbar-nav text-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#choosetpye">Services</a></li>
                    ...
                    <div class="collapse" id="reports">
                        <div class="card card-body bg-white">
                            <ul class="navbar-nav p-0">
                                <li><a class="dropdown-item"href="#" data-bs-toggle="modal" data-bs-target="#choosetpye" data-bs-dismiss="offcanvas">Services</a></li>
                                <hr class="dropdown-divider">
        ...
        <section class="mt-2 pt-2">
            <div class="container">
                        ...
                        if($resident_id == ''){
                            ...
                            foreach($dqs1 as $qdatas1){
                                if($official_img == ''){
                                    ...
                                    echo '<img src="images/'.$qdatas1['profile_id'].'" class="rounded-circle" width="150;" height="150;"alt="...">
                ...
                <!-- <div class="row">
                    ...
                    <?php
                    $qry2 = "SELECT * FROM officials_tbl WHERE official_id > '1' OR official_id < '9'";
                    $dq2 =  $con->query($qry2);
                    $slctr3 = 1;
                    ...
                    if($resident_id == ''){
                        echo '<h4>No assigned official yet</h4>';
                    }
                    else{
                        $qrys1 = "SELECT * FROM penresident WHERE resident_id = '$resident_id'";
                        $dqs1 =  $con->query($qrys1);
                        ...
                        foreach($dqs1 as $qdatas1){
                            if($resident_id == ''){
                                ...
                                echo '<h4>'.$qdatas1['lastname'].', '.$qdatas1['firstname'].' '.$qdatas1['middlename'].'.</h4>';
                            }
                        }
                    }
                    ?>
    ...
    <footer class="text-center text-white bg-danger">
        ...
        <div class="container pt-4">
            ...
            <section class="mb-4">
                <p class="text-center"><a class="btn btn-link text-white" href="mailto: concepciondosmarikina@gmail.com" role="button"><i class="bi bi-envelope me-2"></i>concepciondosmarikina@gmail.com</a></p>
            </section>

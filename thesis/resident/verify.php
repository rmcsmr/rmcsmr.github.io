<?php
    ...
    if(isset($_REQUEST['otp'])){
        ...
        try{
            ...
            $select_stmt = $con->prepare("SELECT email FROM penresident WHERE email = :email AND username IS NOT NULL");
            $select_stmt->execute([':email' => $email]);
            $row = $select_stmt->fetch(PDO::FETCH_ASSOC);
            if(isset($row['email']) == $email){
              $_SESSION['otpsesres']['email'] = $email;
    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="verify.php" method="post" class="sign-in-form" autocomplete="off">

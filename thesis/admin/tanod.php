  ...
  <div class="offcanvas offcanvas-start sidebar-nav" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-body p-0 bg-dark">
      <ul class="navbar-nav">
        ...
        <li>
          <a href="tanod.php" class="nav-link px-3 bg-white active text-dark">
            <span class="me-3">
      ...
      <div class="container">
        <div class="row me-2">
          <div class="col-md-4 shadow-lg bg-body rounded">
            ...
            <div class="row">
              <div class="col-md-12 border bg-danger">
                <a href="tanod.php" class="text-decoration-none"><p id="deliveryguy" class="text-center fs-4 text-white">Brgy. Tanod</p></a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 border">
          ...
          <div class="col-md-8 shadow-lg p-3 bg-body rounded">
            <form action="tanod.php" method="post">
              <div class="container-fluid shadow-lg p-3 bg-body rounded">
                <div class="row m-2 border-bottom border-dark justify-content-between">
                  <div class="col-md-6">
                    <p class="text-left fs-4">Appointed Brgy Tanods</p>
                  </div>
                  <div class="col-md-4">
                ...
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="capt" class="form-label">Barangay Tanod Chief</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '11'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="11">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '12'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="12">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '13'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="13">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '14'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="14">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '15'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="15">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '16'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="16">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '17'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="17">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  <label for="kag1" class="form-label">Barangay Tanod</label>
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '18'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="18">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
                  ...
                  <div class="col-md-8">
                    <?php
                      /** geting data in the db codes */
                      $sql2 = "SELECT * FROM officials_tbl WHERE official_id = '19'";
                      $d2 =  $con->query($sql2);
                      foreach($d2 as $data2){
                        $resident_id = ($data2['resident_id']);
                      }
                  ...
                  <div class="col-md-4">
                    <button type="submit" id="capt" class="btn btn-primary" name="updatelist" value="19">Update</button>
                  </div>
                </div>
                <div class="row p-1 m-2 border-bottom border-dark">
          ...
          <div class="modal-content">
            <form action="tanod.php" method="post">
              ...
              <div class="modal-body">
                <?php
                  if($official_id == 11){
                    echo"<p class='text-center fs-4'>Are you to assign or change the Chief of Barangay Tanod?</p>";
                  }
                  else{
                    echo"<p class='text-center fs-4'>Are you to assign or change this Barangay Tanod?</p>";
                  }
                ?>
              </div>
              <div class="modal-footer">

  ...
  <div class="offcanvas offcanvas-start sidebar-nav" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-body p-0 bg-dark">
      <ul class="navbar-nav">
        ...
        <li>
          <a href="employees.php" class="nav-link px-3 bg-white active text-dark">
            <span class="me-3">
          ...
          <div class="col-md-4 shadow-lg bg-body rounded">
            ...
            <div class="row">
              <div class="col-md-12 border bg-danger">
                <a href="employees.php" class="text-decoration-none"><p id="deliveryguy" class="text-center fs-4 text-white">Brgy. Employees</p></a>
              </div>
            </div>
          </div>
            ...
            <form action="employees.php" method="post">
              <div class="container-fluid shadow-lg p-3 bg-body rounded">
                <div class="row m-2 border-bottom border-dark justify-content-between">
                  <div class="col-md-7">
                    <p class="text-left fs-4">Appointed Brgy Employees</p>
                  </div>
                  <div class="col-md-4">

        ...
        <div class="col-md-4 mb-3">
          <div class="card text-dark border-dark shadow-lg bg-body rounded pb-0 h-100">
            <div class="card-body text-center">
              <h6 class="fw-bold">Pending</h6>
              <h2><?php echo $cnt2; ?></h2>
              <a href="pending_transactions.php" class="btn btn-dark">Open Table</a>
            </div>
          </div>
        </div>
        -->
            ...
            <table id="transaction" class="table table-striped" style="width:100%">
              ...
              <tbody>
                <tr>
                  ...
                  <th>02-22-22</th>
                  <th>02-28-22</th>
                  <th><button type="button" class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#deletemodal">Delete</button></th>
                </tr>
                <tr>
                  ...
                  <th>02-22-22</th>
                  <th>__-__-__</th>
                  <th><button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#releasemodal">Deliver</button></th>
                </tr>
                <tr>
                  <th>Pending</th>
                  ...
                  <th>04-01-22</th>
                  <th>__-__-__</th>
                  <th><button type="button" class="btn btn-info"  data-bs-toggle="modal" data-bs-target="#editmodal">Verify</button>
                </tr>

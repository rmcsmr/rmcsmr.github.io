    ...
    <div class="container-fluid">
      ...
      <div class="col-md-12">
        <div class="btn-group">
          ...
          <a href="archive_transaction.php" class="btn btn-outline-danger active" aria-current="page">Transactions</a>
      ...
      <div class="container-fluid border border-danger p-1 rounded mt-3">
        <div class="row mb-4">
          <div class="col-md-5">
            <i class="bi bi-table"></i>&nbsp;Transaction Deleted Data Table
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <table id="transaction" class="table table-striped" style="width:100%">
              ...
              <tbody>
                <?php
                $sql2 = "SELECT * FROM transactionlist_tbl WHERE status = '3'";
                $d2 =  $con->query($sql2);
                foreach($d2 as $data2){
      ...
      <div class="modal" id="logoutconfmodal" id="editconfmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header p-3 mb-2 bg-secondary text-white">
